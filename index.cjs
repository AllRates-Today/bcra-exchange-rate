'use strict';
// Central Bank of Argentina exchange rates via the AllRatesToday API.
const BASE = 'https://allratestoday.com/api/v1/central-bank/bcra';
...
/** Latest rate for one pair, e.g. getRate('USD', 'ARS', { apiKey }). */
