# Central Bank of Argentina Exchange Rate API — bcra-exchange-rate
...
Also published under the org scope as [`@allratestoday/bcra-exchange-rate`](https://www.npmjs.com/package/@allratestoday/bcra-exchange-rate) — same code, same versions.
...
```javascript
{
  ...
  rate_date: '2026-08-10',   // Central Bank of Argentina's own publication date
  source: 'USD',
  target: 'ARS',
  rate: 1495.5,
  rate_type: 'reference',
...
```javascript
{
  ...
  rates: [
    { "base": "USD", "quote": "ARS", "type": "reference", "value": 1495.5 },
...
const series = await getHistory(
  { source: 'USD', target: 'ARS', from: '2026-01-01', to: '2026-08-10' },
  { apiKey: 'art_live_...' }
);
```
...
```javascript
{
  ...
  rates: [
    ...
    { date: '2026-08-10', rate: 1495.5, rate_type: 'reference', derived: false, method: 'published' },
    // …
  ],
  disclaimer: '…'
}
